...
const BlogContent: React.FC<BlogContentProps> = ({ posts, onPostClick }) => {
  return (
          ...
          {posts.map((post) => (
            <div key={post.id} className="group">
              ...
              <button
                ...
                className="inline-flex items-center text-white font-medium group-hover:text-blue-400 transition-colors"
              >
                Read more
