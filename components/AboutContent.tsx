      ...
      <div className="max-w-3xl mx-auto">
        ...
        <div className="text-center mb-24">
          ...
          <p className="text-lg md:text-xl max-w-2xl mx-auto leading-relaxed">
            The Alliance for Resilient Computing Munich (ARCM) is a student organization at TUM dedicated to exploring and developing civilian and dual-use technological solutions to benefit all of humanity.
          </p>
        </div>
